...
#SBATCH --output=logs/maskrcnn_pretrained_region_South_North_fsall_%j.out
#SBATCH --error=logs/maskrcnn_pretrained_region_South_North_fsall_%j.err
...
OUTPUT_DIR="${REPO_ROOT}/outputs/maskrcnn_pretrained_region_South_North_fsall_${SLURM_JOB_ID}"
