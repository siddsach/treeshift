#!/bin/bash
#SBATCH --job-name=frcnn_biome_Rajasthan_WET_DRY_fsall
...
#SBATCH --output=logs/fastrcnn_biome_Rajasthan_WET_DRY_fsall_%j.out
#SBATCH --error=logs/fastrcnn_biome_Rajasthan_WET_DRY_fsall_%j.err

# -----------------------------------------------------------------------
# Faster R-CNN: biome_Rajasthan_train_WET__ood_DRY__fsall
...
OUTPUT_DIR="${REPO_ROOT}/outputs/fastrcnn_biome_Rajasthan_WET_DRY_fsall_${SLURM_JOB_ID}"
