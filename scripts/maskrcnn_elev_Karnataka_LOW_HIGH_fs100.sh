#!/bin/bash
#SBATCH --job-name=mrcnn_elev_Karnataka_LOW_HIGH_fs100
...
#SBATCH --output=logs/maskrcnn_elev_Karnataka_LOW_HIGH_fs100_%j.out
#SBATCH --error=logs/maskrcnn_elev_Karnataka_LOW_HIGH_fs100_%j.err

# -----------------------------------------------------------------------
# Mask R-CNN: elev_Karnataka_train_LOW__ood_HIGH__fs100
...
OUTPUT_DIR="${REPO_ROOT}/outputs/maskrcnn_elev_Karnataka_LOW_HIGH_fs100_${SLURM_JOB_ID}"
