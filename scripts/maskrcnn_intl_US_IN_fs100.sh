#!/bin/bash
#SBATCH --job-name=mrcnn_intl_US_IN_fs100
...
#SBATCH --output=logs/maskrcnn_intl_US_IN_fs100_%j.out
#SBATCH --error=logs/maskrcnn_intl_US_IN_fs100_%j.err

# -----------------------------------------------------------------------
# Mask R-CNN: intl_train_US__ood_IN__fs100
...
OUTPUT_DIR="${REPO_ROOT}/outputs/maskrcnn_intl_US_IN_fs100_${SLURM_JOB_ID}"
