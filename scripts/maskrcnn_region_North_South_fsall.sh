#!/bin/bash
#SBATCH --job-name=mrcnn_region_North_South_fsall
...
#SBATCH --output=logs/maskrcnn_region_North_South_fsall_%j.out
#SBATCH --error=logs/maskrcnn_region_North_South_fsall_%j.err

# -----------------------------------------------------------------------
# Mask R-CNN: region_train_North__ood_South__fsall
...
OUTPUT_DIR="${REPO_ROOT}/outputs/maskrcnn_region_North_South_fsall_${SLURM_JOB_ID}"
