#!/bin/bash
#SBATCH --job-name=frcnn_pt_region_South_North_fs1
...
#SBATCH --output=logs/fastrcnn_pretrained_region_South_North_fs1_%j.out
#SBATCH --error=logs/fastrcnn_pretrained_region_South_North_fs1_%j.err

# -----------------------------------------------------------------------
# Faster R-CNN (COCO pretrained): region_train_South__ood_North__fs1
...
OUTPUT_DIR="${REPO_ROOT}/outputs/fastrcnn_pretrained_region_South_North_fs1_${SLURM_JOB_ID}"
