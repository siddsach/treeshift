#!/bin/bash
#SBATCH --job-name=frcnn_biome_Rajasthan_DRY_WET
...
#SBATCH --output=logs/fastrcnn_biome_Rajasthan_DRY_WET_%j.out
#SBATCH --error=logs/fastrcnn_biome_Rajasthan_DRY_WET_%j.err

# -----------------------------------------------------------------------
# Faster R-CNN: biome_Rajasthan_train_DRY__ood_WET
...
OUTPUT_DIR="${REPO_ROOT}/outputs/fastrcnn_biome_Rajasthan_DRY_WET_${SLURM_JOB_ID}"
