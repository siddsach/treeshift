#!/bin/bash
#SBATCH --job-name=frcnn_pt_region_South_North_fsall
...
#SBATCH --output=logs/fastrcnn_pretrained_region_South_North_fsall_%j.out
#SBATCH --error=logs/fastrcnn_pretrained_region_South_North_fsall_%j.err

# -----------------------------------------------------------------------
# Faster R-CNN (COCO pretrained): region_train_South__ood_North__fsall
...
OUTPUT_DIR="${REPO_ROOT}/outputs/fastrcnn_pretrained_region_South_North_fsall_${SLURM_JOB_ID}"
