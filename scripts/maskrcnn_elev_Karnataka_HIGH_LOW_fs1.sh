...
#SBATCH --output=logs/maskrcnn_elev_Karnataka_HIGH_LOW_fs1_%j.out
#SBATCH --error=logs/maskrcnn_elev_Karnataka_HIGH_LOW_fs1_%j.err
...
OUTPUT_DIR="${REPO_ROOT}/outputs/maskrcnn_elev_Karnataka_HIGH_LOW_fs1_${SLURM_JOB_ID}"
