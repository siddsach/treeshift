#!/bin/bash
#SBATCH --job-name=mrcnn_region_South_North_fsall
...
#SBATCH --output=logs/maskrcnn_region_South_North_fsall_%j.out
#SBATCH --error=logs/maskrcnn_region_South_North_fsall_%j.err

# -----------------------------------------------------------------------
# Mask R-CNN: region_train_South__ood_North__fsall
...
OUTPUT_DIR="${REPO_ROOT}/outputs/maskrcnn_region_South_North_fsall_${SLURM_JOB_ID}"
