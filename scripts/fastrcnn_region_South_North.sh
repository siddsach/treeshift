#!/bin/bash
#SBATCH --job-name=frcnn_region_South_North
...
#SBATCH --output=logs/fastrcnn_region_South_North_%j.out
#SBATCH --error=logs/fastrcnn_region_South_North_%j.err

# -----------------------------------------------------------------------
# Faster R-CNN: region_train_South__ood_North
...
OUTPUT_DIR="${REPO_ROOT}/outputs/fastrcnn_region_South_North_${SLURM_JOB_ID}"
