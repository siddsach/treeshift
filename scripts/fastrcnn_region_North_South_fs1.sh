#!/bin/bash
#SBATCH --job-name=frcnn_region_North_South_fs1
...
#SBATCH --output=logs/fastrcnn_region_North_South_fs1_%j.out
#SBATCH --error=logs/fastrcnn_region_North_South_fs1_%j.err

# -----------------------------------------------------------------------
# Faster R-CNN: region_train_North__ood_South__fs1
...
OUTPUT_DIR="${REPO_ROOT}/outputs/fastrcnn_region_North_South_fs1_${SLURM_JOB_ID}"
