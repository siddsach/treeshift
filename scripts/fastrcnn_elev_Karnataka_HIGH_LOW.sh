#!/bin/bash
#SBATCH --job-name=frcnn_elev_Karnataka_HIGH_LOW
...
#SBATCH --output=logs/fastrcnn_elev_Karnataka_HIGH_LOW_%j.out
#SBATCH --error=logs/fastrcnn_elev_Karnataka_HIGH_LOW_%j.err

# -----------------------------------------------------------------------
# Faster R-CNN: elev_Karnataka_train_HIGH__ood_LOW
...
OUTPUT_DIR="${REPO_ROOT}/outputs/fastrcnn_elev_Karnataka_HIGH_LOW_${SLURM_JOB_ID}"
