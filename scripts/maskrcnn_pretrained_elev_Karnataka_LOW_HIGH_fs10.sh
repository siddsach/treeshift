#!/bin/bash
#SBATCH --job-name=mrcnn_pt_elev_Karnataka_LOW_HIGH_fs10
...
#SBATCH --output=logs/maskrcnn_pretrained_elev_Karnataka_LOW_HIGH_fs10_%j.out
#SBATCH --error=logs/maskrcnn_pretrained_elev_Karnataka_LOW_HIGH_fs10_%j.err

# -----------------------------------------------------------------------
# Mask R-CNN (COCO pretrained): elev_Karnataka_train_LOW__ood_HIGH__fs10
...
OUTPUT_DIR="${REPO_ROOT}/outputs/maskrcnn_pretrained_elev_Karnataka_LOW_HIGH_fs10_${SLURM_JOB_ID}"
