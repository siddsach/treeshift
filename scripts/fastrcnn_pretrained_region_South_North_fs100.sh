#!/bin/bash
#SBATCH --job-name=frcnn_pt_region_South_North_fs100
...
#SBATCH --output=logs/fastrcnn_pretrained_region_South_North_fs100_%j.out
#SBATCH --error=logs/fastrcnn_pretrained_region_South_North_fs100_%j.err

# -----------------------------------------------------------------------
# Faster R-CNN (COCO pretrained): region_train_South__ood_North__fs100
# 6125 train images, batch 8 (1 GPU), 50 epochs = 38300 iterations.
...
OUTPUT_DIR="${REPO_ROOT}/outputs/fastrcnn_pretrained_region_South_North_fs100_${SLURM_JOB_ID}"
