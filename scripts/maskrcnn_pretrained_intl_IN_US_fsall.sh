#!/bin/bash
#SBATCH --job-name=mrcnn_pt_intl_IN_US_fsall
...
#SBATCH --output=logs/maskrcnn_pretrained_intl_IN_US_fsall_%j.out
#SBATCH --error=logs/maskrcnn_pretrained_intl_IN_US_fsall_%j.err

# -----------------------------------------------------------------------
# Mask R-CNN (COCO pretrained): intl_train_IN__ood_US__fsall
...
OUTPUT_DIR="${REPO_ROOT}/outputs/maskrcnn_pretrained_intl_IN_US_fsall_${SLURM_JOB_ID}"
