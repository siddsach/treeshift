#!/bin/bash
#SBATCH --job-name=frcnn_intl_US_IN_fsall
...
#SBATCH --output=logs/fastrcnn_intl_US_IN_fsall_%j.out
#SBATCH --error=logs/fastrcnn_intl_US_IN_fsall_%j.err

# -----------------------------------------------------------------------
# Faster R-CNN: intl_train_US__ood_IN__fsall
...
OUTPUT_DIR="${REPO_ROOT}/outputs/fastrcnn_intl_US_IN_fsall_${SLURM_JOB_ID}"
