#!/bin/bash
#SBATCH --job-name=frcnn_elev_Karnataka_LOW_HIGH
...
#SBATCH --output=logs/fastrcnn_elev_Karnataka_LOW_HIGH_%j.out
#SBATCH --error=logs/fastrcnn_elev_Karnataka_LOW_HIGH_%j.err

# -----------------------------------------------------------------------
# Faster R-CNN: elev_Karnataka_train_LOW__ood_HIGH
...
OUTPUT_DIR="${REPO_ROOT}/outputs/fastrcnn_elev_Karnataka_LOW_HIGH_${SLURM_JOB_ID}"
