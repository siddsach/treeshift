#!/bin/bash
#SBATCH --job-name=mrcnn_region_North_South_fs1
...
#SBATCH --output=logs/maskrcnn_region_North_South_fs1_%j.out
#SBATCH --error=logs/maskrcnn_region_North_South_fs1_%j.err

# -----------------------------------------------------------------------
# Mask R-CNN: region_train_North__ood_South__fs1
...
OUTPUT_DIR="${REPO_ROOT}/outputs/maskrcnn_region_North_South_fs1_${SLURM_JOB_ID}"
