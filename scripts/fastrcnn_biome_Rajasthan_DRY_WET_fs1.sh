#!/bin/bash
#SBATCH --job-name=frcnn_biome_Rajasthan_DRY_WET_fs1
...
#SBATCH --output=logs/fastrcnn_biome_Rajasthan_DRY_WET_fs1_%j.out
#SBATCH --error=logs/fastrcnn_biome_Rajasthan_DRY_WET_fs1_%j.err

# -----------------------------------------------------------------------
# Faster R-CNN: biome_Rajasthan_train_DRY__ood_WET__fs1
...
OUTPUT_DIR="${REPO_ROOT}/outputs/fastrcnn_biome_Rajasthan_DRY_WET_fs1_${SLURM_JOB_ID}"
