#!/bin/bash
#SBATCH --job-name=frcnn_pt_elev_Karnataka_LOW_HIGH_fs1
...
#SBATCH --output=logs/fastrcnn_pretrained_elev_Karnataka_LOW_HIGH_fs1_%j.out
#SBATCH --error=logs/fastrcnn_pretrained_elev_Karnataka_LOW_HIGH_fs1_%j.err

# -----------------------------------------------------------------------
# Faster R-CNN (COCO pretrained): elev_Karnataka_train_LOW__ood_HIGH__fs1
# 2818 train images, batch 8 (1 GPU), 50 epochs = 17650 iterations.
...
OUTPUT_DIR="${REPO_ROOT}/outputs/fastrcnn_pretrained_elev_Karnataka_LOW_HIGH_fs1_${SLURM_JOB_ID}"
