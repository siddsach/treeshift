#!/bin/bash
#SBATCH --job-name=mrcnn_region_South_North_fs10
...
#SBATCH --output=logs/maskrcnn_region_South_North_fs10_%j.out
#SBATCH --error=logs/maskrcnn_region_South_North_fs10_%j.err

# -----------------------------------------------------------------------
# Mask R-CNN: region_train_South__ood_North__fs10
...
OUTPUT_DIR="${REPO_ROOT}/outputs/maskrcnn_region_South_North_fs10_${SLURM_JOB_ID}"
