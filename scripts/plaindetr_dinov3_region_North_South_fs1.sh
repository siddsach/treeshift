#!/bin/bash
#SBATCH --job-name=pd_dv3_region_North_South_fs1
...
#SBATCH --output=logs/plaindetr_dinov3_region_North_South_fs1_%j.out
#SBATCH --error=logs/plaindetr_dinov3_region_North_South_fs1_%j.err

# -----------------------------------------------------------------------
# Plain-DETR + DinoV3 (ViT-S/16): region_train_North__ood_South__fs1
...
OUTPUT_DIR="${REPO_ROOT}/outputs/plaindetr_dinov3_region_North_South_fs1_${SLURM_JOB_ID}"
...
echo "=== Plain-DETR DinoV3: region_train_North__ood_South__fs1 ==="
