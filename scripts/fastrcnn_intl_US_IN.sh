#!/bin/bash
#SBATCH --job-name=frcnn_intl_US_IN
...
#SBATCH --output=logs/fastrcnn_intl_US_IN_%j.out
#SBATCH --error=logs/fastrcnn_intl_US_IN_%j.err

# -----------------------------------------------------------------------
# Faster R-CNN: intl_train_US__ood_IN
...
OUTPUT_DIR="${REPO_ROOT}/outputs/fastrcnn_intl_US_IN_${SLURM_JOB_ID}"
