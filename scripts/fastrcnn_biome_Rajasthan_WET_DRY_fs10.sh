#!/bin/bash
#SBATCH --job-name=frcnn_biome_Rajasthan_WET_DRY_fs10
...
#SBATCH --output=logs/fastrcnn_biome_Rajasthan_WET_DRY_fs10_%j.out
#SBATCH --error=logs/fastrcnn_biome_Rajasthan_WET_DRY_fs10_%j.err

# -----------------------------------------------------------------------
# Faster R-CNN: biome_Rajasthan_train_WET__ood_DRY__fs10
...
OUTPUT_DIR="${REPO_ROOT}/outputs/fastrcnn_biome_Rajasthan_WET_DRY_fs10_${SLURM_JOB_ID}"
