#!/bin/bash
#SBATCH --job-name=frcnn_pt_elev_Karnataka_LOW_HIGH_fsall
...
#SBATCH --output=logs/fastrcnn_pretrained_elev_Karnataka_LOW_HIGH_fsall_%j.out
#SBATCH --error=logs/fastrcnn_pretrained_elev_Karnataka_LOW_HIGH_fsall_%j.err

# -----------------------------------------------------------------------
# Faster R-CNN (COCO pretrained): elev_Karnataka_train_LOW__ood_HIGH__fsall
# 4645 train images, batch 20 (2 GPUs), 50 epochs = 11650 iterations.
...
OUTPUT_DIR="${REPO_ROOT}/outputs/fastrcnn_pretrained_elev_Karnataka_LOW_HIGH_fsall_${SLURM_JOB_ID}"
