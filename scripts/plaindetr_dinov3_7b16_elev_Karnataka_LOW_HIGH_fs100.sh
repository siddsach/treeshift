...
#SBATCH --output=logs/plaindetr_dinov3_7b16_elev_Karnataka_LOW_HIGH_fs100_%j.out
#SBATCH --error=logs/plaindetr_dinov3_7b16_elev_Karnataka_LOW_HIGH_fs100_%j.err

# -----------------------------------------------------------------------
# Plain-DETR + DinoV3 (dino_weights_7b16): elev_Karnataka_train_LOW__ood_HIGH__fs100
# 2917 train images, batch 2/GPU × 3 A100 GPUs, 50 epochs max.
...
OUTPUT_DIR="${REPO_ROOT}/outputs/plaindetr_dinov3_7b16_elev_Karnataka_LOW_HIGH_fs100_${SLURM_JOB_ID}"
...
echo "=== Plain-DETR DinoV3 (7b16): elev_Karnataka_train_LOW__ood_HIGH__fs100 ==="
