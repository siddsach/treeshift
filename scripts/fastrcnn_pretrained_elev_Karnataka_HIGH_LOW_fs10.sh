...
# 2361 train images, batch 8 (1 GPU), 50 epochs = 14800 iterations.
...
OUTPUT_DIR="${REPO_ROOT}/outputs/fastrcnn_pretrained_elev_Karnataka_HIGH_LOW_fs10_${SLURM_JOB_ID}"
