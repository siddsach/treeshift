#!/bin/bash
#SBATCH --job-name=frcnn_elev_Karnataka_LOW_HIGH_fsall
...
#SBATCH --output=logs/fastrcnn_elev_Karnataka_LOW_HIGH_fsall_%j.out
#SBATCH --error=logs/fastrcnn_elev_Karnataka_LOW_HIGH_fsall_%j.err

# -----------------------------------------------------------------------
# Faster R-CNN: elev_Karnataka_train_LOW__ood_HIGH__fsall
...
OUTPUT_DIR="${REPO_ROOT}/outputs/fastrcnn_elev_Karnataka_LOW_HIGH_fsall_${SLURM_JOB_ID}"
