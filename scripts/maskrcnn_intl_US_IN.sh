#!/bin/bash
#SBATCH --job-name=mrcnn_intl_US_IN
...
#SBATCH --output=logs/maskrcnn_intl_US_IN_%j.out
#SBATCH --error=logs/maskrcnn_intl_US_IN_%j.err

# -----------------------------------------------------------------------
# Mask R-CNN: intl_train_US__ood_IN
...
OUTPUT_DIR="${REPO_ROOT}/outputs/maskrcnn_intl_US_IN_${SLURM_JOB_ID}"
