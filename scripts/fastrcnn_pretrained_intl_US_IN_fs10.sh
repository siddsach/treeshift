...
# 8933 train images, batch 20 (2 GPUs), 50 epochs = 22350 iterations.
...
OUTPUT_DIR="${REPO_ROOT}/outputs/fastrcnn_pretrained_intl_US_IN_fs10_${SLURM_JOB_ID}"
