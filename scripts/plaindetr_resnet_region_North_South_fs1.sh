#!/bin/bash
#SBATCH --job-name=pd_rn_region_North_South_fs1
...
#SBATCH --output=logs/plaindetr_resnet_region_North_South_fs1_%j.out
#SBATCH --error=logs/plaindetr_resnet_region_North_South_fs1_%j.err

# -----------------------------------------------------------------------
# Plain-DETR + ResNet-50 FPN backbone: region_train_North__ood_South__fs1
...
OUTPUT_DIR="${REPO_ROOT}/outputs/plaindetr_resnet_region_North_South_fs1_${SLURM_JOB_ID}"
...
echo "=== Plain-DETR ResNet50: region_train_North__ood_South__fs1 ==="
