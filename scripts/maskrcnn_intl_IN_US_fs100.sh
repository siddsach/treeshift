...
#SBATCH --output=logs/maskrcnn_intl_IN_US_fs100_%j.out
#SBATCH --error=logs/maskrcnn_intl_IN_US_fs100_%j.err
...
OUTPUT_DIR="${REPO_ROOT}/outputs/maskrcnn_intl_IN_US_fs100_${SLURM_JOB_ID}"
