#!/bin/bash
#SBATCH --job-name=frcnn_region_North_South_fsall
...
#SBATCH --output=logs/fastrcnn_region_North_South_fsall_%j.out
#SBATCH --error=logs/fastrcnn_region_North_South_fsall_%j.err

# -----------------------------------------------------------------------
# Faster R-CNN: region_train_North__ood_South__fsall
...
OUTPUT_DIR="${REPO_ROOT}/outputs/fastrcnn_region_North_South_fsall_${SLURM_JOB_ID}"
