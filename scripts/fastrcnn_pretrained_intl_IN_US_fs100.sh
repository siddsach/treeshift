#!/bin/bash
#SBATCH --job-name=frcnn_pt_intl_IN_US_fs100
...
#SBATCH --output=logs/fastrcnn_pretrained_intl_IN_US_fs100_%j.out
#SBATCH --error=logs/fastrcnn_pretrained_intl_IN_US_fs100_%j.err

# -----------------------------------------------------------------------
# Faster R-CNN (COCO pretrained): intl_train_IN__ood_US__fs100
...
OUTPUT_DIR="${REPO_ROOT}/outputs/fastrcnn_pretrained_intl_IN_US_fs100_${SLURM_JOB_ID}"
