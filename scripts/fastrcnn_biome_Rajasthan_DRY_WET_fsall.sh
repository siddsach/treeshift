#!/bin/bash
#SBATCH --job-name=frcnn_biome_Rajasthan_DRY_WET_fsall
...
#SBATCH --output=logs/fastrcnn_biome_Rajasthan_DRY_WET_fsall_%j.out
#SBATCH --error=logs/fastrcnn_biome_Rajasthan_DRY_WET_fsall_%j.err

# -----------------------------------------------------------------------
# Faster R-CNN: biome_Rajasthan_train_DRY__ood_WET__fsall
...
OUTPUT_DIR="${REPO_ROOT}/outputs/fastrcnn_biome_Rajasthan_DRY_WET_fsall_${SLURM_JOB_ID}"
