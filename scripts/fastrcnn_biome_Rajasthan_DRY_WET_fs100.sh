#!/bin/bash
#SBATCH --job-name=frcnn_biome_Rajasthan_DRY_WET_fs100
...
#SBATCH --output=logs/fastrcnn_biome_Rajasthan_DRY_WET_fs100_%j.out
#SBATCH --error=logs/fastrcnn_biome_Rajasthan_DRY_WET_fs100_%j.err

# -----------------------------------------------------------------------
# Faster R-CNN: biome_Rajasthan_train_DRY__ood_WET__fs100
...
OUTPUT_DIR="${REPO_ROOT}/outputs/fastrcnn_biome_Rajasthan_DRY_WET_fs100_${SLURM_JOB_ID}"
