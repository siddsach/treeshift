#!/bin/bash
#SBATCH --job-name=frcnn_region_South_North_fs100
...
#SBATCH --output=logs/fastrcnn_region_South_North_fs100_%j.out
#SBATCH --error=logs/fastrcnn_region_South_North_fs100_%j.err

# -----------------------------------------------------------------------
# Faster R-CNN: region_train_South__ood_North__fs100
...
OUTPUT_DIR="${REPO_ROOT}/outputs/fastrcnn_region_South_North_fs100_${SLURM_JOB_ID}"
