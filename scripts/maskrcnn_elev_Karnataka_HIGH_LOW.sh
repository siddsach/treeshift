#!/bin/bash
#SBATCH --job-name=mrcnn_elev_Karnataka_HIGH_LOW
...
#SBATCH --output=logs/maskrcnn_elev_Karnataka_HIGH_LOW_%j.out
#SBATCH --error=logs/maskrcnn_elev_Karnataka_HIGH_LOW_%j.err

# -----------------------------------------------------------------------
# Mask R-CNN: elev_Karnataka_train_HIGH__ood_LOW
...
OUTPUT_DIR="${REPO_ROOT}/outputs/maskrcnn_elev_Karnataka_HIGH_LOW_${SLURM_JOB_ID}"
