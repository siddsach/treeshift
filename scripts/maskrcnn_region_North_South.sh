...
#SBATCH --output=logs/maskrcnn_region_North_South_%j.out
#SBATCH --error=logs/maskrcnn_region_North_South_%j.err
...
OUTPUT_DIR="${REPO_ROOT}/outputs/maskrcnn_region_North_South_${SLURM_JOB_ID}"
