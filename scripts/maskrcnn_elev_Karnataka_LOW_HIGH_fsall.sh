#!/bin/bash
#SBATCH --job-name=mrcnn_elev_Karnataka_LOW_HIGH_fsall
...
#SBATCH --output=logs/maskrcnn_elev_Karnataka_LOW_HIGH_fsall_%j.out
#SBATCH --error=logs/maskrcnn_elev_Karnataka_LOW_HIGH_fsall_%j.err

# -----------------------------------------------------------------------
# Mask R-CNN: elev_Karnataka_train_LOW__ood_HIGH__fsall
...
OUTPUT_DIR="${REPO_ROOT}/outputs/maskrcnn_elev_Karnataka_LOW_HIGH_fsall_${SLURM_JOB_ID}"
