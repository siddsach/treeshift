#!/bin/bash
#SBATCH --job-name=frcnn_intl_US_IN_fs1
...
#SBATCH --output=logs/fastrcnn_intl_US_IN_fs1_%j.out
#SBATCH --error=logs/fastrcnn_intl_US_IN_fs1_%j.err

# -----------------------------------------------------------------------
# Faster R-CNN: intl_train_US__ood_IN__fs1
...
OUTPUT_DIR="${REPO_ROOT}/outputs/fastrcnn_intl_US_IN_fs1_${SLURM_JOB_ID}"
