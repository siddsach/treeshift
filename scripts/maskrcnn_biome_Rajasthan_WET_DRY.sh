#!/bin/bash
#SBATCH --job-name=mrcnn_biome_Rajasthan_WET_DRY
...
#SBATCH --output=logs/maskrcnn_biome_Rajasthan_WET_DRY_%j.out
#SBATCH --error=logs/maskrcnn_biome_Rajasthan_WET_DRY_%j.err

# -----------------------------------------------------------------------
# Mask R-CNN: biome_Rajasthan_train_WET__ood_DRY
...
OUTPUT_DIR="${REPO_ROOT}/outputs/maskrcnn_biome_Rajasthan_WET_DRY_${SLURM_JOB_ID}"
