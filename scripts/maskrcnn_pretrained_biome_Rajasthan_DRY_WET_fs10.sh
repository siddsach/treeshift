...
#SBATCH --output=logs/maskrcnn_pretrained_biome_Rajasthan_DRY_WET_fs10_%j.out
#SBATCH --error=logs/maskrcnn_pretrained_biome_Rajasthan_DRY_WET_fs10_%j.err
...
OUTPUT_DIR="${REPO_ROOT}/outputs/maskrcnn_pretrained_biome_Rajasthan_DRY_WET_fs10_${SLURM_JOB_ID}"
