#!/bin/bash
#SBATCH --job-name=frcnn_pt_biome_Rajasthan_DRY_WET_fsall
...
#SBATCH --output=logs/fastrcnn_pretrained_biome_Rajasthan_DRY_WET_fsall_%j.out
#SBATCH --error=logs/fastrcnn_pretrained_biome_Rajasthan_DRY_WET_fsall_%j.err

# -----------------------------------------------------------------------
# Faster R-CNN (COCO pretrained): biome_Rajasthan_train_DRY__ood_WET__fsall
# 3268 train images, batch 16 (2 GPUs), 50 epochs = 10250 iterations.
...
OUTPUT_DIR="${REPO_ROOT}/outputs/fastrcnn_pretrained_biome_Rajasthan_DRY_WET_fsall_${SLURM_JOB_ID}"
