#!/bin/bash
#SBATCH --job-name=mrcnn_elev_Karnataka_HIGH_LOW_fs100
...
#SBATCH --output=logs/maskrcnn_elev_Karnataka_HIGH_LOW_fs100_%j.out
#SBATCH --error=logs/maskrcnn_elev_Karnataka_HIGH_LOW_fs100_%j.err

# -----------------------------------------------------------------------
# Mask R-CNN: elev_Karnataka_train_HIGH__ood_LOW__fs100
...
OUTPUT_DIR="${REPO_ROOT}/outputs/maskrcnn_elev_Karnataka_HIGH_LOW_fs100_${SLURM_JOB_ID}"
