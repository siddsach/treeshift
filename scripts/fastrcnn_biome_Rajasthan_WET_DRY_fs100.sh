...
#SBATCH --output=logs/fastrcnn_biome_Rajasthan_WET_DRY_fs100_%j.out
#SBATCH --error=logs/fastrcnn_biome_Rajasthan_WET_DRY_fs100_%j.err
...
OUTPUT_DIR="${REPO_ROOT}/outputs/fastrcnn_biome_Rajasthan_WET_DRY_fs100_${SLURM_JOB_ID}"
