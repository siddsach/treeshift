#!/bin/bash
#SBATCH --job-name=mrcnn_biome_Rajasthan_WET_DRY_fs1
...
#SBATCH --output=logs/maskrcnn_biome_Rajasthan_WET_DRY_fs1_%j.out
#SBATCH --error=logs/maskrcnn_biome_Rajasthan_WET_DRY_fs1_%j.err

# -----------------------------------------------------------------------
# Mask R-CNN: biome_Rajasthan_train_WET__ood_DRY__fs1
...
OUTPUT_DIR="${REPO_ROOT}/outputs/maskrcnn_biome_Rajasthan_WET_DRY_fs1_${SLURM_JOB_ID}"
