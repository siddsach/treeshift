#!/bin/bash
#SBATCH --job-name=frcnn_intl_IN_US_fs1
...
#SBATCH --output=logs/fastrcnn_intl_IN_US_fs1_%j.out
#SBATCH --error=logs/fastrcnn_intl_IN_US_fs1_%j.err

# -----------------------------------------------------------------------
# Faster R-CNN: intl_train_IN__ood_US__fs1
...
OUTPUT_DIR="${REPO_ROOT}/outputs/fastrcnn_intl_IN_US_fs1_${SLURM_JOB_ID}"
