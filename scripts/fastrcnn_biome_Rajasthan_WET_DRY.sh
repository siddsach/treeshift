#!/bin/bash
#SBATCH --job-name=frcnn_biome_Rajasthan_WET_DRY
...
#SBATCH --output=logs/fastrcnn_biome_Rajasthan_WET_DRY_%j.out
#SBATCH --error=logs/fastrcnn_biome_Rajasthan_WET_DRY_%j.err

# -----------------------------------------------------------------------
# Faster R-CNN: biome_Rajasthan_train_WET__ood_DRY
...
OUTPUT_DIR="${REPO_ROOT}/outputs/fastrcnn_biome_Rajasthan_WET_DRY_${SLURM_JOB_ID}"
