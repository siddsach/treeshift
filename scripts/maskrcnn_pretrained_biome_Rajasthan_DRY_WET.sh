#!/bin/bash
#SBATCH --job-name=mrcnn_pt_biome_Rajasthan_DRY_WET
...
#SBATCH --output=logs/maskrcnn_pretrained_biome_Rajasthan_DRY_WET_%j.out
#SBATCH --error=logs/maskrcnn_pretrained_biome_Rajasthan_DRY_WET_%j.err

# -----------------------------------------------------------------------
# Mask R-CNN (COCO pretrained): biome_Rajasthan_train_DRY__ood_WET
...
OUTPUT_DIR="${REPO_ROOT}/outputs/maskrcnn_pretrained_biome_Rajasthan_DRY_WET_${SLURM_JOB_ID}"
