#!/bin/bash
#SBATCH --job-name=frcnn_pt_intl_IN_US_fs10
...
#SBATCH --output=logs/fastrcnn_pretrained_intl_IN_US_fs10_%j.out
#SBATCH --error=logs/fastrcnn_pretrained_intl_IN_US_fs10_%j.err

# -----------------------------------------------------------------------
# Faster R-CNN (COCO pretrained): intl_train_IN__ood_US__fs10
# 12153 train images, batch 24 (2 GPUs), 50 epochs = 25350 iterations.
...
OUTPUT_DIR="${REPO_ROOT}/outputs/fastrcnn_pretrained_intl_IN_US_fs10_${SLURM_JOB_ID}"
