#!/bin/bash
#SBATCH --job-name=frcnn_pt_intl_IN_US_fsall
...
#SBATCH --output=logs/fastrcnn_pretrained_intl_IN_US_fsall_%j.out
#SBATCH --error=logs/fastrcnn_pretrained_intl_IN_US_fsall_%j.err

# -----------------------------------------------------------------------
# Faster R-CNN (COCO pretrained): intl_train_IN__ood_US__fsall
# 19083 train images, batch 24 (2 GPUs), 50 epochs = 39800 iterations.
...
OUTPUT_DIR="${REPO_ROOT}/outputs/fastrcnn_pretrained_intl_IN_US_fsall_${SLURM_JOB_ID}"
