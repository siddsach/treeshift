#!/bin/bash
#SBATCH --job-name=frcnn_pt_region_South_North
...
#SBATCH --output=logs/fastrcnn_pretrained_region_South_North_%j.out
#SBATCH --error=logs/fastrcnn_pretrained_region_South_North_%j.err

# -----------------------------------------------------------------------
# Faster R-CNN (COCO pretrained): region_train_South__ood_North
# 6025 train images, batch 20 (2 GPUs), 50 epochs = 15100 iterations.
...
OUTPUT_DIR="${REPO_ROOT}/outputs/fastrcnn_pretrained_region_South_North_${SLURM_JOB_ID}"
