#!/bin/bash
#SBATCH --job-name=frcnn_pt_elev_Karnataka_LOW_HIGH_fs100
...
#SBATCH --output=logs/fastrcnn_pretrained_elev_Karnataka_LOW_HIGH_fs100_%j.out
#SBATCH --error=logs/fastrcnn_pretrained_elev_Karnataka_LOW_HIGH_fs100_%j.err

# -----------------------------------------------------------------------
# Faster R-CNN (COCO pretrained): elev_Karnataka_train_LOW__ood_HIGH__fs100
# 2917 train images, batch 16 (2 GPUs), 50 epochs = 9150 iterations.
...
OUTPUT_DIR="${REPO_ROOT}/outputs/fastrcnn_pretrained_elev_Karnataka_LOW_HIGH_fs100_${SLURM_JOB_ID}"
