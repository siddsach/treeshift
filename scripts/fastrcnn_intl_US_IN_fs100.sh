#!/bin/bash
#SBATCH --job-name=frcnn_intl_US_IN_fs100
...
#SBATCH --output=logs/fastrcnn_intl_US_IN_fs100_%j.out
#SBATCH --error=logs/fastrcnn_intl_US_IN_fs100_%j.err

# -----------------------------------------------------------------------
# Faster R-CNN: intl_train_US__ood_IN__fs100
...
OUTPUT_DIR="${REPO_ROOT}/outputs/fastrcnn_intl_US_IN_fs100_${SLURM_JOB_ID}"
