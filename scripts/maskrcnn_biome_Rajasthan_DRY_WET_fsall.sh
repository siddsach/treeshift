#!/bin/bash
#SBATCH --job-name=mrcnn_biome_Rajasthan_DRY_WET_fsall
...
#SBATCH --output=logs/maskrcnn_biome_Rajasthan_DRY_WET_fsall_%j.out
#SBATCH --error=logs/maskrcnn_biome_Rajasthan_DRY_WET_fsall_%j.err

# -----------------------------------------------------------------------
# Mask R-CNN: biome_Rajasthan_train_DRY__ood_WET__fsall
...
OUTPUT_DIR="${REPO_ROOT}/outputs/maskrcnn_biome_Rajasthan_DRY_WET_fsall_${SLURM_JOB_ID}"
