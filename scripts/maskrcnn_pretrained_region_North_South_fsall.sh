#!/bin/bash
#SBATCH --job-name=mrcnn_pt_region_North_South_fsall
...
#SBATCH --output=logs/maskrcnn_pretrained_region_North_South_fsall_%j.out
#SBATCH --error=logs/maskrcnn_pretrained_region_North_South_fsall_%j.err

# -----------------------------------------------------------------------
# Mask R-CNN (COCO pretrained): region_train_North__ood_South__fsall
...
OUTPUT_DIR="${REPO_ROOT}/outputs/maskrcnn_pretrained_region_North_South_fsall_${SLURM_JOB_ID}"
