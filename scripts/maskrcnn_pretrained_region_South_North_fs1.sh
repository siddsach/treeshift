#!/bin/bash
#SBATCH --job-name=mrcnn_pt_region_South_North_fs1
...
#SBATCH --output=logs/maskrcnn_pretrained_region_South_North_fs1_%j.out
#SBATCH --error=logs/maskrcnn_pretrained_region_South_North_fs1_%j.err

# -----------------------------------------------------------------------
# Mask R-CNN (COCO pretrained): region_train_South__ood_North__fs1
...
OUTPUT_DIR="${REPO_ROOT}/outputs/maskrcnn_pretrained_region_South_North_fs1_${SLURM_JOB_ID}"
