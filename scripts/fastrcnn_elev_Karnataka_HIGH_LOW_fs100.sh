#!/bin/bash
#SBATCH --job-name=frcnn_elev_Karnataka_HIGH_LOW_fs100
...
#SBATCH --output=logs/fastrcnn_elev_Karnataka_HIGH_LOW_fs100_%j.out
#SBATCH --error=logs/fastrcnn_elev_Karnataka_HIGH_LOW_fs100_%j.err

# -----------------------------------------------------------------------
# Faster R-CNN: elev_Karnataka_train_HIGH__ood_LOW__fs100
...
OUTPUT_DIR="${REPO_ROOT}/outputs/fastrcnn_elev_Karnataka_HIGH_LOW_fs100_${SLURM_JOB_ID}"
