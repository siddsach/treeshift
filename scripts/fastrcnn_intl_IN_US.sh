#!/bin/bash
#SBATCH --job-name=frcnn_intl_IN_US
...
#SBATCH --output=logs/fastrcnn_intl_IN_US_%j.out
#SBATCH --error=logs/fastrcnn_intl_IN_US_%j.err

# -----------------------------------------------------------------------
# Faster R-CNN: intl_train_IN__ood_US
...
OUTPUT_DIR="${REPO_ROOT}/outputs/fastrcnn_intl_IN_US_${SLURM_JOB_ID}"
