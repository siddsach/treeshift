#!/bin/bash
#SBATCH --job-name=mrcnn_pt_intl_IN_US
...
#SBATCH --output=logs/maskrcnn_pretrained_intl_IN_US_%j.out
#SBATCH --error=logs/maskrcnn_pretrained_intl_IN_US_%j.err

# -----------------------------------------------------------------------
# Mask R-CNN (COCO pretrained): intl_train_IN__ood_US
...
OUTPUT_DIR="${REPO_ROOT}/outputs/maskrcnn_pretrained_intl_IN_US_${SLURM_JOB_ID}"
