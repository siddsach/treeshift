#!/bin/bash
#SBATCH --job-name=mrcnn_pt_elev_Karnataka_HIGH_LOW_fs100
...
#SBATCH --output=logs/maskrcnn_pretrained_elev_Karnataka_HIGH_LOW_fs100_%j.out
#SBATCH --error=logs/maskrcnn_pretrained_elev_Karnataka_HIGH_LOW_fs100_%j.err

# -----------------------------------------------------------------------
# Mask R-CNN (COCO pretrained): elev_Karnataka_train_HIGH__ood_LOW__fs100
# 2451 train images, batch 16 (2 GPUs), 50 epochs = 7700 iterations.
...
OUTPUT_DIR="${REPO_ROOT}/outputs/maskrcnn_pretrained_elev_Karnataka_HIGH_LOW_fs100_${SLURM_JOB_ID}"
