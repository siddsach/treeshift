#!/bin/bash
#SBATCH --job-name=mrcnn_pt_biome_Rajasthan_DRY_WET_fs1
...
#SBATCH --output=logs/maskrcnn_pretrained_biome_Rajasthan_DRY_WET_fs1_%j.out
#SBATCH --error=logs/maskrcnn_pretrained_biome_Rajasthan_DRY_WET_fs1_%j.err

# -----------------------------------------------------------------------
# Mask R-CNN (COCO pretrained): biome_Rajasthan_train_DRY__ood_WET__fs1
...
OUTPUT_DIR="${REPO_ROOT}/outputs/maskrcnn_pretrained_biome_Rajasthan_DRY_WET_fs1_${SLURM_JOB_ID}"
