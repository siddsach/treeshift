...
# 10804 train images, batch 20 (2 GPUs), 50 epochs = 27050 iterations.
...
OUTPUT_DIR="${REPO_ROOT}/outputs/fastrcnn_pretrained_region_North_South_fsall_${SLURM_JOB_ID}"
