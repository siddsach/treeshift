#!/bin/bash
#SBATCH --job-name=frcnn_pt_intl_US_IN_fsall
...
#SBATCH --output=logs/fastrcnn_pretrained_intl_US_IN_fsall_%j.out
#SBATCH --error=logs/fastrcnn_pretrained_intl_US_IN_fsall_%j.err

# -----------------------------------------------------------------------
# Faster R-CNN (COCO pretrained): intl_train_US__ood_IN__fsall
# 18367 train images, batch 24 (2 GPUs), 50 epochs = 38300 iterations.
...
OUTPUT_DIR="${REPO_ROOT}/outputs/fastrcnn_pretrained_intl_US_IN_fsall_${SLURM_JOB_ID}"
