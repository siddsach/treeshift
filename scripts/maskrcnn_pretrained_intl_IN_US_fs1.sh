#!/bin/bash
#SBATCH --job-name=mrcnn_pt_intl_IN_US_fs1
...
#SBATCH --output=logs/maskrcnn_pretrained_intl_IN_US_fs1_%j.out
#SBATCH --error=logs/maskrcnn_pretrained_intl_IN_US_fs1_%j.err

# -----------------------------------------------------------------------
# Mask R-CNN (COCO pretrained): intl_train_IN__ood_US__fs1
...
OUTPUT_DIR="${REPO_ROOT}/outputs/maskrcnn_pretrained_intl_IN_US_fs1_${SLURM_JOB_ID}"
