#!/bin/bash
#SBATCH --job-name=mrcnn_pt_intl_US_IN_fs10
...
#SBATCH --output=logs/maskrcnn_pretrained_intl_US_IN_fs10_%j.out
#SBATCH --error=logs/maskrcnn_pretrained_intl_US_IN_fs10_%j.err

# -----------------------------------------------------------------------
# Mask R-CNN (COCO pretrained): intl_train_US__ood_IN__fs10
...
OUTPUT_DIR="${REPO_ROOT}/outputs/maskrcnn_pretrained_intl_US_IN_fs10_${SLURM_JOB_ID}"
