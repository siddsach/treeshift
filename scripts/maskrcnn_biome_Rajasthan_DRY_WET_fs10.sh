#!/bin/bash
#SBATCH --job-name=mrcnn_biome_Rajasthan_DRY_WET_fs10
...
#SBATCH --output=logs/maskrcnn_biome_Rajasthan_DRY_WET_fs10_%j.out
#SBATCH --error=logs/maskrcnn_biome_Rajasthan_DRY_WET_fs10_%j.err

# -----------------------------------------------------------------------
# Mask R-CNN: biome_Rajasthan_train_DRY__ood_WET__fs10
...
OUTPUT_DIR="${REPO_ROOT}/outputs/maskrcnn_biome_Rajasthan_DRY_WET_fs10_${SLURM_JOB_ID}"
