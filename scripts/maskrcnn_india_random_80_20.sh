#!/bin/bash
#SBATCH --job-name=mrcnn_india_random_80_20
...
#SBATCH --output=logs/maskrcnn_india_random_80_20_%j.out
#SBATCH --error=logs/maskrcnn_india_random_80_20_%j.err

# -----------------------------------------------------------------------
# Mask R-CNN: india_random_80_20
...
OUTPUT_DIR="${REPO_ROOT}/outputs/maskrcnn_india_random_80_20_${SLURM_JOB_ID}"
