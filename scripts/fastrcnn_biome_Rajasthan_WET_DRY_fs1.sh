#!/bin/bash
#SBATCH --job-name=frcnn_biome_Rajasthan_WET_DRY_fs1
...
#SBATCH --output=logs/fastrcnn_biome_Rajasthan_WET_DRY_fs1_%j.out
#SBATCH --error=logs/fastrcnn_biome_Rajasthan_WET_DRY_fs1_%j.err

# -----------------------------------------------------------------------
# Faster R-CNN: biome_Rajasthan_train_WET__ood_DRY__fs1
...
OUTPUT_DIR="${REPO_ROOT}/outputs/fastrcnn_biome_Rajasthan_WET_DRY_fs1_${SLURM_JOB_ID}"
