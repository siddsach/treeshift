#!/bin/bash
#SBATCH --job-name=mrcnn_pt_region_South_North
...
#SBATCH --output=logs/maskrcnn_pretrained_region_South_North_%j.out
#SBATCH --error=logs/maskrcnn_pretrained_region_South_North_%j.err

# -----------------------------------------------------------------------
# Mask R-CNN (COCO pretrained): region_train_South__ood_North
...
OUTPUT_DIR="${REPO_ROOT}/outputs/maskrcnn_pretrained_region_South_North_${SLURM_JOB_ID}"
