#!/bin/bash
#SBATCH --job-name=frcnn_intl_US_IN_fs10
...
#SBATCH --output=logs/fastrcnn_intl_US_IN_fs10_%j.out
#SBATCH --error=logs/fastrcnn_intl_US_IN_fs10_%j.err

# -----------------------------------------------------------------------
# Faster R-CNN: intl_train_US__ood_IN__fs10
...
OUTPUT_DIR="${REPO_ROOT}/outputs/fastrcnn_intl_US_IN_fs10_${SLURM_JOB_ID}"
