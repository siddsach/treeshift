#!/bin/bash
#SBATCH --job-name=mrcnn_pt_elev_Karnataka_HIGH_LOW_fs1
...
#SBATCH --output=logs/maskrcnn_pretrained_elev_Karnataka_HIGH_LOW_fs1_%j.out
#SBATCH --error=logs/maskrcnn_pretrained_elev_Karnataka_HIGH_LOW_fs1_%j.err

# -----------------------------------------------------------------------
# Mask R-CNN (COCO pretrained): elev_Karnataka_train_HIGH__ood_LOW__fs1
...
OUTPUT_DIR="${REPO_ROOT}/outputs/maskrcnn_pretrained_elev_Karnataka_HIGH_LOW_fs1_${SLURM_JOB_ID}"
