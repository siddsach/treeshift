#!/bin/bash
#SBATCH --job-name=mrcnn_region_North_South_fs10
...
#SBATCH --output=logs/maskrcnn_region_North_South_fs10_%j.out
#SBATCH --error=logs/maskrcnn_region_North_South_fs10_%j.err

# -----------------------------------------------------------------------
# Mask R-CNN: region_train_North__ood_South__fs10
...
OUTPUT_DIR="${REPO_ROOT}/outputs/maskrcnn_region_North_South_fs10_${SLURM_JOB_ID}"
