#!/bin/bash
#SBATCH --job-name=frcnn_pt_region_South_North_fs10
...
#SBATCH --output=logs/fastrcnn_pretrained_region_South_North_fs10_%j.out
#SBATCH --error=logs/fastrcnn_pretrained_region_South_North_fs10_%j.err

# -----------------------------------------------------------------------
# Faster R-CNN (COCO pretrained): region_train_South__ood_North__fs10
# 6035 train images, batch 8 (1 GPU), 50 epochs = 37750 iterations.
...
OUTPUT_DIR="${REPO_ROOT}/outputs/fastrcnn_pretrained_region_South_North_fs10_${SLURM_JOB_ID}"
