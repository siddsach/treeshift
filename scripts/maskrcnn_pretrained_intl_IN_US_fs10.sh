#!/bin/bash
#SBATCH --job-name=mrcnn_pt_intl_IN_US_fs10
...
#SBATCH --output=logs/maskrcnn_pretrained_intl_IN_US_fs10_%j.out
#SBATCH --error=logs/maskrcnn_pretrained_intl_IN_US_fs10_%j.err

# -----------------------------------------------------------------------
# Mask R-CNN (COCO pretrained): intl_train_IN__ood_US__fs10
