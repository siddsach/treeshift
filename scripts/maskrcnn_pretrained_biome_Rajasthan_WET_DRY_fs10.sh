#!/bin/bash
#SBATCH --job-name=mrcnn_pt_biome_Rajasthan_WET_DRY_fs10
...
#SBATCH --output=logs/maskrcnn_pretrained_biome_Rajasthan_WET_DRY_fs10_%j.out
#SBATCH --error=logs/maskrcnn_pretrained_biome_Rajasthan_WET_DRY_fs10_%j.err

# -----------------------------------------------------------------------
# Mask R-CNN (COCO pretrained): biome_Rajasthan_train_WET__ood_DRY__fs10
...
OUTPUT_DIR="${REPO_ROOT}/outputs/maskrcnn_pretrained_biome_Rajasthan_WET_DRY_fs10_${SLURM_JOB_ID}"
