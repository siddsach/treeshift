#!/bin/bash
#SBATCH --job-name=mrcnn_pt_biome_Rajasthan_DRY_WET_fsall
...
#SBATCH --output=logs/maskrcnn_pretrained_biome_Rajasthan_DRY_WET_fsall_%j.out
#SBATCH --error=logs/maskrcnn_pretrained_biome_Rajasthan_DRY_WET_fsall_%j.err

# -----------------------------------------------------------------------
# Mask R-CNN (COCO pretrained): biome_Rajasthan_train_DRY__ood_WET__fsall
...
OUTPUT_DIR="${REPO_ROOT}/outputs/maskrcnn_pretrained_biome_Rajasthan_DRY_WET_fsall_${SLURM_JOB_ID}"
