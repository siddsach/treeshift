#!/bin/bash
#SBATCH --job-name=mrcnn_pt_intl_US_IN_fsall
...
#SBATCH --output=logs/maskrcnn_pretrained_intl_US_IN_fsall_%j.out
#SBATCH --error=logs/maskrcnn_pretrained_intl_US_IN_fsall_%j.err

# -----------------------------------------------------------------------
# Mask R-CNN (COCO pretrained): intl_train_US__ood_IN__fsall
...
OUTPUT_DIR="${REPO_ROOT}/outputs/maskrcnn_pretrained_intl_US_IN_fsall_${SLURM_JOB_ID}"
