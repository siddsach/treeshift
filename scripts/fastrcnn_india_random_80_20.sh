#!/bin/bash
#SBATCH --job-name=frcnn_india_random_80_20
...
#SBATCH --output=logs/fastrcnn_india_random_80_20_%j.out
#SBATCH --error=logs/fastrcnn_india_random_80_20_%j.err

# -----------------------------------------------------------------------
# Faster R-CNN: india_random_80_20
...
OUTPUT_DIR="${REPO_ROOT}/outputs/fastrcnn_india_random_80_20_${SLURM_JOB_ID}"
