#!/bin/bash
#SBATCH --job-name=mrcnn_pt_intl_US_IN_fs100
...
#SBATCH --output=logs/maskrcnn_pretrained_intl_US_IN_fs100_%j.out
#SBATCH --error=logs/maskrcnn_pretrained_intl_US_IN_fs100_%j.err

# -----------------------------------------------------------------------
# Mask R-CNN (COCO pretrained): intl_train_US__ood_IN__fs100
# 9023 train images, batch 8 (1 GPU), 50 epochs = 56400 iterations.
...
OUTPUT_DIR="${REPO_ROOT}/outputs/maskrcnn_pretrained_intl_US_IN_fs100_${SLURM_JOB_ID}"
