#!/bin/bash
#SBATCH --job-name=frcnn_intl_IN_US_fsall
...
#SBATCH --output=logs/fastrcnn_intl_IN_US_fsall_%j.out
#SBATCH --error=logs/fastrcnn_intl_IN_US_fsall_%j.err

# -----------------------------------------------------------------------
# Faster R-CNN: intl_train_IN__ood_US__fsall
...
OUTPUT_DIR="${REPO_ROOT}/outputs/fastrcnn_intl_IN_US_fsall_${SLURM_JOB_ID}"
