#!/bin/bash
#SBATCH --job-name=frcnn_region_North_South
...
#SBATCH --output=logs/fastrcnn_region_North_South_%j.out
#SBATCH --error=logs/fastrcnn_region_North_South_%j.err

# -----------------------------------------------------------------------
# Faster R-CNN: region_train_North__ood_South
...
OUTPUT_DIR="${REPO_ROOT}/outputs/fastrcnn_region_North_South_${SLURM_JOB_ID}"
