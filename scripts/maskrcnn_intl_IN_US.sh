#!/bin/bash
#SBATCH --job-name=mrcnn_intl_IN_US
...
#SBATCH --output=logs/maskrcnn_intl_IN_US_%j.out
#SBATCH --error=logs/maskrcnn_intl_IN_US_%j.err

# -----------------------------------------------------------------------
# Mask R-CNN: intl_train_IN__ood_US
...
OUTPUT_DIR="${REPO_ROOT}/outputs/maskrcnn_intl_IN_US_${SLURM_JOB_ID}"
