#!/bin/bash
#SBATCH --job-name=grounding_dino_IN_US
...
#SBATCH --output=logs/grounding_dino_IN_US_%j.out
#SBATCH --error=logs/grounding_dino_IN_US_%j.err

# -----------------------------------------------------------------------------
# MM-Grounding-DINO: train India, test USA.
...
OUTPUT_DIR="${REPO_ROOT}/outputs/grounding_dino_IN_US_${SLURM_JOB_ID}"
...
echo "=== GroundingDINO: train India, OOD USA ==="
