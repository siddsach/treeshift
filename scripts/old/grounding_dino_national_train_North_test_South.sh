#!/bin/bash
#SBATCH --job-name=grounding_dino_North_South
...
#SBATCH --output=logs/grounding_dino_North_South_%j.out
#SBATCH --error=logs/grounding_dino_North_South_%j.err

# -----------------------------------------------------------------------------
# MM-Grounding-DINO: train North India, test South India.
...
OUTPUT_DIR="${REPO_ROOT}/outputs/grounding_dino_national_North_South_${SLURM_JOB_ID}"
...
echo "=== GroundingDINO: train North India, OOD South India ==="
