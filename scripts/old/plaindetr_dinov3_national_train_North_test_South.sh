#!/bin/bash
#SBATCH --job-name=plaindetr_dinov3_North_South
...
#SBATCH --output=logs/plaindetr_dinov3_North_South_%j.out
#SBATCH --error=logs/plaindetr_dinov3_North_South_%j.err

# -----------------------------------------------------------------------------
# Plain-DETR with DinoV3 backbone: train North India, test South India.
...
OUTPUT_DIR="${REPO_ROOT}/outputs/plaindetr_dinov3_North_South_${SLURM_JOB_ID}"
...
echo "=== Plain-DETR DinoV3: train North India, OOD South India ==="
