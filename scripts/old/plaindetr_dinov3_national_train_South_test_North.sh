#!/bin/bash
#SBATCH --job-name=plaindetr_dinov3_South_North
...
#SBATCH --output=logs/plaindetr_dinov3_South_North_%j.out
#SBATCH --error=logs/plaindetr_dinov3_South_North_%j.err

# -----------------------------------------------------------------------------
# Plain-DETR with DinoV3 backbone: train South India, test North India.
...
OUTPUT_DIR="${REPO_ROOT}/outputs/plaindetr_dinov3_South_North_${SLURM_JOB_ID}"
...
echo "=== Plain-DETR DinoV3: train South India, OOD North India ==="
