#!/bin/bash
#SBATCH --job-name=grounding_dino_WET_DRY
...
#SBATCH --output=logs/grounding_dino_WET_DRY_%j.out
#SBATCH --error=logs/grounding_dino_WET_DRY_%j.err

# -----------------------------------------------------------------------------
# MM-Grounding-DINO: train Rajasthan WET, test Rajasthan DRY.
...
OUTPUT_DIR="${REPO_ROOT}/outputs/grounding_dino_WET_DRY_${SLURM_JOB_ID}"
...
echo "=== GroundingDINO: train Rajasthan WET, OOD Rajasthan DRY ==="
