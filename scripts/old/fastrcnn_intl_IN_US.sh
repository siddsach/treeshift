#!/bin/bash
#SBATCH --job-name=fastrcnn_IN_US
...
#SBATCH --output=logs/fastrcnn_IN_US_%j.out
#SBATCH --error=logs/fastrcnn_IN_US_%j.err

# -----------------------------------------------------------------------------
# Fast R-CNN: International shift — train India (South), test USA (North). 1 GPU.
...
OUTPUT_DIR=./outputs/fastrcnn_IN_US_${SLURM_JOB_ID}
