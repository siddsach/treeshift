#!/bin/bash
#SBATCH --job-name=maskrcnn_North_South
...
#SBATCH --output=logs/maskrcnn_North_South_%j.out
#SBATCH --error=logs/maskrcnn_North_South_%j.err

set -euo pipefail

# -----------------------------------------------------------------------------
# Mask R-CNN: National shift — train North India, test South India. 1 GPU.
...
OUTPUT_DIR=./outputs/maskrcnn_national_North_South_${SLURM_JOB_ID}
