#!/bin/bash
#SBATCH --job-name=fastrcnn_North_South
...
#SBATCH --output=logs/fastrcnn_North_South_%j.out
#SBATCH --error=logs/fastrcnn_North_South_%j.err

# -----------------------------------------------------------------------------
# Fast R-CNN: National shift — train North India, test South India. 1 GPU.
...
OUTPUT_DIR=./outputs/fastrcnn_national_North_South_${SLURM_JOB_ID}
