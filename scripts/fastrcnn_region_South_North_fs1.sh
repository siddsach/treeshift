...
#SBATCH --output=logs/fastrcnn_region_South_North_fs1_%j.out
#SBATCH --error=logs/fastrcnn_region_South_North_fs1_%j.err
...
OUTPUT_DIR="${REPO_ROOT}/outputs/fastrcnn_region_South_North_fs1_${SLURM_JOB_ID}"
