...
# 6218 train images, batch 20 (2 GPUs), 50 epochs = 15550 iterations.
...
OUTPUT_DIR="${REPO_ROOT}/outputs/fastrcnn_pretrained_region_North_South_fs100_${SLURM_JOB_ID}"
