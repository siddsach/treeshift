#!/bin/bash
#SBATCH --job-name=pd_dv3_7b16_region_North_South_fs1
...
#SBATCH --output=logs/plaindetr_dinov3_7b16_region_North_South_fs1_%j.out
#SBATCH --error=logs/plaindetr_dinov3_7b16_region_North_South_fs1_%j.err

# -----------------------------------------------------------------------
# Plain-DETR + DinoV3 (dino_weights_7b16): region_train_North__ood_South__fs1
# 6119 train images, batch 2/GPU × 3 A100 GPUs, 50 epochs max.
...
OUTPUT_DIR="${REPO_ROOT}/outputs/plaindetr_dinov3_7b16_region_North_South_fs1_${SLURM_JOB_ID}"
...
echo "=== Plain-DETR DinoV3 (7b16): region_train_North__ood_South__fs1 ==="
