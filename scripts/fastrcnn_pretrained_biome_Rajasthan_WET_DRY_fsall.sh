...
# 3218 train images, batch 16 (2 GPUs), 50 epochs = 10100 iterations.
...
OUTPUT_DIR="${REPO_ROOT}/outputs/fastrcnn_pretrained_biome_Rajasthan_WET_DRY_fsall_${SLURM_JOB_ID}"
