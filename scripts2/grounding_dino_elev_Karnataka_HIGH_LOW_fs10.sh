#!/bin/bash
#SBATCH --job-name=gdino_elev_Karnataka_HIGH_LOW_fs10
...
#SBATCH --mem=32G
#SBATCH --time=8:00:00
#SBATCH --output=logs/grounding_dino_elev_Karnataka_HIGH_LOW_fs10_%j.out
#SBATCH --error=logs/grounding_dino_elev_Karnataka_HIGH_LOW_fs10_%j.err

# -----------------------------------------------------------------------
# MM-Grounding-DINO: elev_Karnataka_train_HIGH__ood_LOW__fs10
# 2361 train images, batch 2/GPU × 1 GPU, 40 epochs max.
...
OUTPUT_DIR="${REPO_ROOT}/outputs/grounding_dino_elev_Karnataka_HIGH_LOW_fs10_1gpu40ep_${SLURM_JOB_ID}"
NUM_GPUS=1
...
echo "=== GroundingDINO: elev_Karnataka_train_HIGH__ood_LOW__fs10 ==="
