#!/bin/bash
#SBATCH --job-name=gdino_elev_Karnataka_LOW_HIGH_fs10
...
#SBATCH --mem=32G
#SBATCH --time=8:00:00
#SBATCH --output=logs/grounding_dino_elev_Karnataka_LOW_HIGH_fs10_%j.out
#SBATCH --error=logs/grounding_dino_elev_Karnataka_LOW_HIGH_fs10_%j.err

# -----------------------------------------------------------------------
# MM-Grounding-DINO: elev_Karnataka_train_LOW__ood_HIGH__fs10
# 2827 train images, batch 2/GPU × 1 GPU, 40 epochs max.
...
OUTPUT_DIR="${REPO_ROOT}/outputs/grounding_dino_elev_Karnataka_LOW_HIGH_fs10_1gpu40ep_${SLURM_JOB_ID}"
NUM_GPUS=1
...
echo "=== GroundingDINO: elev_Karnataka_train_LOW__ood_HIGH__fs10 ==="
