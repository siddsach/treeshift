#!/bin/bash
#SBATCH --job-name=gdino_india_random_80_20
...
#SBATCH --output=logs/grounding_dino_india_random_80_20_%j.out
#SBATCH --error=logs/grounding_dino_india_random_80_20_%j.err

# -----------------------------------------------------------------------
# MM-Grounding-DINO: india_random_80_20
# 10794 train images, batch 2/GPU × 1 GPU, 40 epochs max.
...
OUTPUT_DIR="${REPO_ROOT}/outputs/grounding_dino_india_random_80_20_1gpu40ep_${SLURM_JOB_ID}"
NUM_GPUS=1
...
echo "=== GroundingDINO: india_random_80_20 ==="
