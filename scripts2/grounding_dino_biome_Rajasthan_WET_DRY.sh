#!/bin/bash
#SBATCH --job-name=gdino_biome_Rajasthan_WET_DRY
...
#SBATCH --output=logs/grounding_dino_biome_Rajasthan_WET_DRY_%j.out
#SBATCH --error=logs/grounding_dino_biome_Rajasthan_WET_DRY_%j.err

# -----------------------------------------------------------------------
# MM-Grounding-DINO: biome_Rajasthan_train_WET__ood_DRY
# 1714 train images, batch 2/GPU × 1 GPU, 40 epochs max.
...
OUTPUT_DIR="${REPO_ROOT}/outputs/grounding_dino_biome_Rajasthan_WET_DRY_1gpu40ep_${SLURM_JOB_ID}"
NUM_GPUS=1
...
echo "=== GroundingDINO: biome_Rajasthan_train_WET__ood_DRY ==="
