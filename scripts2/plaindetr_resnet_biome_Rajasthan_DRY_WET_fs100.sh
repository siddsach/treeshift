#!/bin/bash
#SBATCH --job-name=pd_rn_biome_Rajasthan_DRY_WET_fs100
...
#SBATCH --output=logs/plaindetr_resnet_biome_Rajasthan_DRY_WET_fs100_%j.out
#SBATCH --error=logs/plaindetr_resnet_biome_Rajasthan_DRY_WET_fs100_%j.err

# -----------------------------------------------------------------------
# Plain-DETR + ResNet-50 FPN backbone: biome_Rajasthan_train_DRY__ood_WET__fs100
...
OUTPUT_DIR="${REPO_ROOT}/outputs/plaindetr_resnet_biome_Rajasthan_DRY_WET_fs100_1gpu40ep_${SLURM_JOB_ID}"
...
echo "=== Plain-DETR ResNet50: biome_Rajasthan_train_DRY__ood_WET__fs100 ==="
