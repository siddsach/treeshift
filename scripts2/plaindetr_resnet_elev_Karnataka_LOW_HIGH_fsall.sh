#!/bin/bash
#SBATCH --job-name=pd_rn_elev_Karnataka_LOW_HIGH_fsall
...
#SBATCH --output=logs/plaindetr_resnet_elev_Karnataka_LOW_HIGH_fsall_%j.out
#SBATCH --error=logs/plaindetr_resnet_elev_Karnataka_LOW_HIGH_fsall_%j.err

# -----------------------------------------------------------------------
# Plain-DETR + ResNet-50 FPN backbone: elev_Karnataka_train_LOW__ood_HIGH__fsall
...
OUTPUT_DIR="${REPO_ROOT}/outputs/plaindetr_resnet_elev_Karnataka_LOW_HIGH_fsall_1gpu40ep_${SLURM_JOB_ID}"
...
echo "=== Plain-DETR ResNet50: elev_Karnataka_train_LOW__ood_HIGH__fsall ==="
