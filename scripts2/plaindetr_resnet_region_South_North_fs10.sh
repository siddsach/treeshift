#!/bin/bash
#SBATCH --job-name=pd_rn_region_South_North_fs10
...
#SBATCH --output=logs/plaindetr_resnet_region_South_North_fs10_%j.out
#SBATCH --error=logs/plaindetr_resnet_region_South_North_fs10_%j.err

# -----------------------------------------------------------------------
# Plain-DETR + ResNet-50 FPN backbone: region_train_South__ood_North__fs10
...
OUTPUT_DIR="${REPO_ROOT}/outputs/plaindetr_resnet_region_South_North_fs10_1gpu40ep_${SLURM_JOB_ID}"
...
echo "=== Plain-DETR ResNet50: region_train_South__ood_North__fs10 ==="
