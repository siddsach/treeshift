#!/bin/bash
#SBATCH --job-name=pd_dv3_sat_intl_US_IN_fsall
...
#SBATCH --output=logs/plaindetr_dinov3_sat_intl_US_IN_fsall_%j.out
#SBATCH --error=logs/plaindetr_dinov3_sat_intl_US_IN_fsall_%j.err

# -----------------------------------------------------------------------
# Plain-DETR + DinoV3 (dino_weights_sat): intl_train_US__ood_IN__fsall
...
OUTPUT_DIR="${REPO_ROOT}/outputs/plaindetr_dinov3_sat_intl_US_IN_fsall_1gpu40ep_${SLURM_JOB_ID}"
...
echo "=== Plain-DETR DinoV3 (sat): intl_train_US__ood_IN__fsall ==="
