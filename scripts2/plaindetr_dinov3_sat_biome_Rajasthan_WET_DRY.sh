#!/bin/bash
#SBATCH --job-name=pd_dv3_sat_biome_Rajasthan_WET_DRY
...
#SBATCH --output=logs/plaindetr_dinov3_sat_biome_Rajasthan_WET_DRY_%j.out
#SBATCH --error=logs/plaindetr_dinov3_sat_biome_Rajasthan_WET_DRY_%j.err

# -----------------------------------------------------------------------
# Plain-DETR + DinoV3 (dino_weights_sat): biome_Rajasthan_train_WET__ood_DRY
...
OUTPUT_DIR="${REPO_ROOT}/outputs/plaindetr_dinov3_sat_biome_Rajasthan_WET_DRY_1gpu40ep_${SLURM_JOB_ID}"
...
echo "=== Plain-DETR DinoV3 (sat): biome_Rajasthan_train_WET__ood_DRY ==="
