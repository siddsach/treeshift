#!/bin/bash
#SBATCH --job-name=frcnn_pt_region_North_South_fs100
...
#SBATCH --output=logs/fastrcnn_pretrained_region_North_South_fs100_%j.out
#SBATCH --error=logs/fastrcnn_pretrained_region_North_South_fs100_%j.err

# -----------------------------------------------------------------------
# Faster R-CNN (COCO pretrained): region_train_North__ood_South__fs100
# 6218 train images, batch 10 (1 GPU), 40 epochs = 24880 iterations.
...
OUTPUT_DIR="${REPO_ROOT}/outputs/fastrcnn_pretrained_region_North_South_fs100_1gpu40ep_${SLURM_JOB_ID}"
