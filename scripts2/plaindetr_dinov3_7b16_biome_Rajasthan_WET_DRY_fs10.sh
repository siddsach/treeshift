...
#SBATCH --output=logs/plaindetr_dinov3_7b16_biome_Rajasthan_WET_DRY_fs10_%j.out
#SBATCH --error=logs/plaindetr_dinov3_7b16_biome_Rajasthan_WET_DRY_fs10_%j.err

# -----------------------------------------------------------------------
# Plain-DETR + DinoV3 (dino_weights_7b16): biome_Rajasthan_train_WET__ood_DRY__fs10
# 1724 train images, batch 2/GPU × 1 A100 GPU, 40 epochs max.
...
OUTPUT_DIR="${REPO_ROOT}/outputs/plaindetr_dinov3_7b16_biome_Rajasthan_WET_DRY_fs10_1gpu40ep_${SLURM_JOB_ID}"
...
echo "=== Plain-DETR DinoV3 (7b16): biome_Rajasthan_train_WET__ood_DRY__fs10 ==="
