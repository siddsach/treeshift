#!/bin/bash
#SBATCH --job-name=pd_dv3_sat_biome_Rajasthan_DRY_WET_fs1
...
#SBATCH --output=logs/plaindetr_dinov3_sat_biome_Rajasthan_DRY_WET_fs1_%j.out
#SBATCH --error=logs/plaindetr_dinov3_sat_biome_Rajasthan_DRY_WET_fs1_%j.err

# -----------------------------------------------------------------------
# Plain-DETR + DinoV3 (dino_weights_sat): biome_Rajasthan_train_DRY__ood_WET__fs1
...
OUTPUT_DIR="${REPO_ROOT}/outputs/plaindetr_dinov3_sat_biome_Rajasthan_DRY_WET_fs1_1gpu40ep_${SLURM_JOB_ID}"
...
echo "=== Plain-DETR DinoV3 (sat): biome_Rajasthan_train_DRY__ood_WET__fs1 ==="
