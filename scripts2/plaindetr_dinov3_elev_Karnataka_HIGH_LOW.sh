#!/bin/bash
#SBATCH --job-name=pd_dv3_elev_Karnataka_HIGH_LOW
...
#SBATCH --output=logs/plaindetr_dinov3_elev_Karnataka_HIGH_LOW_%j.out
#SBATCH --error=logs/plaindetr_dinov3_elev_Karnataka_HIGH_LOW_%j.err

# -----------------------------------------------------------------------
# Plain-DETR + DinoV3 (ViT-S/16): elev_Karnataka_train_HIGH__ood_LOW
...
OUTPUT_DIR="${REPO_ROOT}/outputs/plaindetr_dinov3_elev_Karnataka_HIGH_LOW_1gpu40ep_${SLURM_JOB_ID}"
...
echo "=== Plain-DETR DinoV3: elev_Karnataka_train_HIGH__ood_LOW ==="
