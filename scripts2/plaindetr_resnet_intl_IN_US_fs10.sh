#!/bin/bash
#SBATCH --job-name=pd_rn_intl_IN_US_fs10
...
#SBATCH --output=logs/plaindetr_resnet_intl_IN_US_fs10_%j.out
#SBATCH --error=logs/plaindetr_resnet_intl_IN_US_fs10_%j.err

# -----------------------------------------------------------------------
# Plain-DETR + ResNet-50 FPN backbone: intl_train_IN__ood_US__fs10
...
OUTPUT_DIR="${REPO_ROOT}/outputs/plaindetr_resnet_intl_IN_US_fs10_1gpu40ep_${SLURM_JOB_ID}"
...
echo "=== Plain-DETR ResNet50: intl_train_IN__ood_US__fs10 ==="
