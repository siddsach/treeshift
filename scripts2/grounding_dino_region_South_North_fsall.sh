#!/bin/bash
#SBATCH --job-name=gdino_region_South_North_fsall
...
#SBATCH --output=logs/grounding_dino_region_South_North_fsall_%j.out
#SBATCH --error=logs/grounding_dino_region_South_North_fsall_%j.err

# -----------------------------------------------------------------------
# MM-Grounding-DINO: region_train_South__ood_North__fsall
# 10784 train images, batch 2/GPU × 1 GPU, 40 epochs max.
...
OUTPUT_DIR="${REPO_ROOT}/outputs/grounding_dino_region_South_North_fsall_1gpu40ep_${SLURM_JOB_ID}"
NUM_GPUS=1
...
echo "=== GroundingDINO: region_train_South__ood_North__fsall ==="
