#!/bin/bash
#SBATCH --job-name=frcnn_pt_elev_Karnataka_HIGH_LOW_fs1
...
#SBATCH --output=logs/fastrcnn_pretrained_elev_Karnataka_HIGH_LOW_fs1_%j.out
#SBATCH --error=logs/fastrcnn_pretrained_elev_Karnataka_HIGH_LOW_fs1_%j.err

# -----------------------------------------------------------------------
# Faster R-CNN (COCO pretrained): elev_Karnataka_train_HIGH__ood_LOW__fs1
# 2352 train images, batch 8 (1 GPU), 40 epochs = 11760 iterations.
...
OUTPUT_DIR="${REPO_ROOT}/outputs/fastrcnn_pretrained_elev_Karnataka_HIGH_LOW_fs1_1gpu40ep_${SLURM_JOB_ID}"
