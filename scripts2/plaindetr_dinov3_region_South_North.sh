#!/bin/bash
#SBATCH --job-name=pd_dv3_region_South_North
...
#SBATCH --output=logs/plaindetr_dinov3_region_South_North_%j.out
#SBATCH --error=logs/plaindetr_dinov3_region_South_North_%j.err

# -----------------------------------------------------------------------
# Plain-DETR + DinoV3 (ViT-S/16): region_train_South__ood_North
...
OUTPUT_DIR="${REPO_ROOT}/outputs/plaindetr_dinov3_region_South_North_1gpu40ep_${SLURM_JOB_ID}"
...
echo "=== Plain-DETR DinoV3: region_train_South__ood_North ==="
