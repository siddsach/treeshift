#!/bin/bash
#SBATCH --job-name=frcnn_pt_elev_Karnataka_HIGH_LOW_fsall
...
#SBATCH --output=logs/fastrcnn_pretrained_elev_Karnataka_HIGH_LOW_fsall_%j.out
#SBATCH --error=logs/fastrcnn_pretrained_elev_Karnataka_HIGH_LOW_fsall_%j.err

# -----------------------------------------------------------------------
# Faster R-CNN (COCO pretrained): elev_Karnataka_train_HIGH__ood_LOW__fsall
# 4542 train images, batch 10 (1 GPU), 40 epochs = 18200 iterations.
...
OUTPUT_DIR="${REPO_ROOT}/outputs/fastrcnn_pretrained_elev_Karnataka_HIGH_LOW_fsall_1gpu40ep_${SLURM_JOB_ID}"
