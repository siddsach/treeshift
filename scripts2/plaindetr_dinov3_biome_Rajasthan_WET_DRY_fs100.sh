#!/bin/bash
#SBATCH --job-name=pd_dv3_biome_Rajasthan_WET_DRY_fs100
...
#SBATCH --output=logs/plaindetr_dinov3_biome_Rajasthan_WET_DRY_fs100_%j.out
#SBATCH --error=logs/plaindetr_dinov3_biome_Rajasthan_WET_DRY_fs100_%j.err

# -----------------------------------------------------------------------
# Plain-DETR + DinoV3 (ViT-S/16): biome_Rajasthan_train_WET__ood_DRY__fs100
...
OUTPUT_DIR="${REPO_ROOT}/outputs/plaindetr_dinov3_biome_Rajasthan_WET_DRY_fs100_1gpu40ep_${SLURM_JOB_ID}"
...
echo "=== Plain-DETR DinoV3: biome_Rajasthan_train_WET__ood_DRY__fs100 ==="
