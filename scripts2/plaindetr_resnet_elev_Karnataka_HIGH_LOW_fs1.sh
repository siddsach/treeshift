#!/bin/bash
#SBATCH --job-name=pd_rn_elev_Karnataka_HIGH_LOW_fs1
...
#SBATCH --output=logs/plaindetr_resnet_elev_Karnataka_HIGH_LOW_fs1_%j.out
#SBATCH --error=logs/plaindetr_resnet_elev_Karnataka_HIGH_LOW_fs1_%j.err

# -----------------------------------------------------------------------
# Plain-DETR + ResNet-50 FPN backbone: elev_Karnataka_train_HIGH__ood_LOW__fs1
...
OUTPUT_DIR="${REPO_ROOT}/outputs/plaindetr_resnet_elev_Karnataka_HIGH_LOW_fs1_1gpu40ep_${SLURM_JOB_ID}"
...
echo "=== Plain-DETR ResNet50: elev_Karnataka_train_HIGH__ood_LOW__fs1 ==="
