#!/bin/bash
#SBATCH --job-name=pd_rn_biome_Rajasthan_WET_DRY_fs10
...
#SBATCH --output=logs/plaindetr_resnet_biome_Rajasthan_WET_DRY_fs10_%j.out
#SBATCH --error=logs/plaindetr_resnet_biome_Rajasthan_WET_DRY_fs10_%j.err

# -----------------------------------------------------------------------
# Plain-DETR + ResNet-50 FPN backbone: biome_Rajasthan_train_WET__ood_DRY__fs10
...
OUTPUT_DIR="${REPO_ROOT}/outputs/plaindetr_resnet_biome_Rajasthan_WET_DRY_fs10_1gpu40ep_${SLURM_JOB_ID}"
...
echo "=== Plain-DETR ResNet50: biome_Rajasthan_train_WET__ood_DRY__fs10 ==="
