#!/bin/bash
#SBATCH --job-name=pd_dv3_intl_IN_US_fsall
...
#SBATCH --output=logs/plaindetr_dinov3_intl_IN_US_fsall_%j.out
#SBATCH --error=logs/plaindetr_dinov3_intl_IN_US_fsall_%j.err

# -----------------------------------------------------------------------
# Plain-DETR + DinoV3 (ViT-S/16): intl_train_IN__ood_US__fsall
...
OUTPUT_DIR="${REPO_ROOT}/outputs/plaindetr_dinov3_intl_IN_US_fsall_1gpu40ep_${SLURM_JOB_ID}"
...
echo "=== Plain-DETR DinoV3: intl_train_IN__ood_US__fsall ==="
