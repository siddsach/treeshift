#!/bin/bash
#SBATCH --job-name=pd_rn_intl_US_IN_fs1
...
#SBATCH --output=logs/plaindetr_resnet_intl_US_IN_fs1_%j.out
#SBATCH --error=logs/plaindetr_resnet_intl_US_IN_fs1_%j.err

# -----------------------------------------------------------------------
# Plain-DETR + ResNet-50 FPN backbone: intl_train_US__ood_IN__fs1
...
OUTPUT_DIR="${REPO_ROOT}/outputs/plaindetr_resnet_intl_US_IN_fs1_1gpu40ep_${SLURM_JOB_ID}"
...
echo "=== Plain-DETR ResNet50: intl_train_US__ood_IN__fs1 ==="
