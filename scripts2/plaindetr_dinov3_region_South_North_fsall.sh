#!/bin/bash
#SBATCH --job-name=pd_dv3_region_South_North_fsall
...
#SBATCH --output=logs/plaindetr_dinov3_region_South_North_fsall_%j.out
#SBATCH --error=logs/plaindetr_dinov3_region_South_North_fsall_%j.err

# -----------------------------------------------------------------------
# Plain-DETR + DinoV3 (ViT-S/16): region_train_South__ood_North__fsall
...
OUTPUT_DIR="${REPO_ROOT}/outputs/plaindetr_dinov3_region_South_North_fsall_1gpu40ep_${SLURM_JOB_ID}"
...
echo "=== Plain-DETR DinoV3: region_train_South__ood_North__fsall ==="
