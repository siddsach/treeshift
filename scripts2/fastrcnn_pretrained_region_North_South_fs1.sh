#!/bin/bash
#SBATCH --job-name=frcnn_pt_region_North_South_fs1
...
#SBATCH --output=logs/fastrcnn_pretrained_region_North_South_fs1_%j.out
#SBATCH --error=logs/fastrcnn_pretrained_region_North_South_fs1_%j.err

# -----------------------------------------------------------------------
# Faster R-CNN (COCO pretrained): region_train_North__ood_South__fs1
# 6119 train images, batch 10 (1 GPU), 40 epochs = 24480 iterations.
...
OUTPUT_DIR="${REPO_ROOT}/outputs/fastrcnn_pretrained_region_North_South_fs1_1gpu40ep_${SLURM_JOB_ID}"
