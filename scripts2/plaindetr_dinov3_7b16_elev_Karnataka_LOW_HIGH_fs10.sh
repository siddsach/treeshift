#!/bin/bash
#SBATCH --job-name=pd_dv3_7b16_elev_Karnataka_LOW_HIGH_fs10
...
#SBATCH --output=logs/plaindetr_dinov3_7b16_elev_Karnataka_LOW_HIGH_fs10_%j.out
#SBATCH --error=logs/plaindetr_dinov3_7b16_elev_Karnataka_LOW_HIGH_fs10_%j.err

# -----------------------------------------------------------------------
# Plain-DETR + DinoV3 (dino_weights_7b16): elev_Karnataka_train_LOW__ood_HIGH__fs10
# 2827 train images, batch 2/GPU × 1 A100 GPU, 40 epochs max.
...
CONFIG=elev_Karnataka_train_LOW__ood_HIGH__fs10
OUTPUT_DIR="${REPO_ROOT}/outputs/plaindetr_dinov3_7b16_elev_Karnataka_LOW_HIGH_fs10_1gpu40ep_${SLURM_JOB_ID}"
...
echo "=== Plain-DETR DinoV3 (7b16): elev_Karnataka_train_LOW__ood_HIGH__fs10 ==="
