#!/bin/bash
#SBATCH --job-name=pd_dv3_intl_US_IN
...
#SBATCH --output=logs/plaindetr_dinov3_intl_US_IN_%j.out
#SBATCH --error=logs/plaindetr_dinov3_intl_US_IN_%j.err

# -----------------------------------------------------------------------
# Plain-DETR + DinoV3 (ViT-S/16): intl_train_US__ood_IN
...
OUTPUT_DIR="${REPO_ROOT}/outputs/plaindetr_dinov3_intl_US_IN_1gpu40ep_${SLURM_JOB_ID}"
...
echo "=== Plain-DETR DinoV3: intl_train_US__ood_IN ==="
