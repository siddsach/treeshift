#!/bin/bash
#SBATCH --job-name=gdino_biome_Rajasthan_DRY_WET_fs100
...
#SBATCH --mem=32G
#SBATCH --time=8:00:00
#SBATCH --output=logs/grounding_dino_biome_Rajasthan_DRY_WET_fs100_%j.out
#SBATCH --error=logs/grounding_dino_biome_Rajasthan_DRY_WET_fs100_%j.err

# -----------------------------------------------------------------------
# MM-Grounding-DINO: biome_Rajasthan_train_DRY__ood_WET__fs100
# 2034 train images, batch 2/GPU × 1 GPU, 40 epochs max.
...
OUTPUT_DIR="${REPO_ROOT}/outputs/grounding_dino_biome_Rajasthan_DRY_WET_fs100_1gpu40ep_${SLURM_JOB_ID}"
NUM_GPUS=1
...
echo "=== GroundingDINO: biome_Rajasthan_train_DRY__ood_WET__fs100 ==="
