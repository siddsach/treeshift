#!/bin/bash
#SBATCH --job-name=pd_dv3_7b16_region_North_South_fs10
...
#SBATCH --output=logs/plaindetr_dinov3_7b16_region_North_South_fs10_%j.out
#SBATCH --error=logs/plaindetr_dinov3_7b16_region_North_South_fs10_%j.err

# -----------------------------------------------------------------------
# Plain-DETR + DinoV3 (dino_weights_7b16): region_train_North__ood_South__fs10
# 6128 train images, batch 2/GPU × 1 A100 GPU, 40 epochs max.
...
OUTPUT_DIR="${REPO_ROOT}/outputs/plaindetr_dinov3_7b16_region_North_South_fs10_1gpu40ep_${SLURM_JOB_ID}"
...
echo "=== Plain-DETR DinoV3 (7b16): region_train_North__ood_South__fs10 ==="
