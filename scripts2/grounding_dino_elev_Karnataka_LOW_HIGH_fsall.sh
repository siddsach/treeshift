#!/bin/bash
#SBATCH --job-name=gdino_elev_Karnataka_LOW_HIGH_fsall
...
#SBATCH --output=logs/grounding_dino_elev_Karnataka_LOW_HIGH_fsall_%j.out
#SBATCH --error=logs/grounding_dino_elev_Karnataka_LOW_HIGH_fsall_%j.err

# -----------------------------------------------------------------------
# MM-Grounding-DINO: elev_Karnataka_train_LOW__ood_HIGH__fsall
# 4645 train images, batch 2/GPU × 1 GPU, 40 epochs max.
...
OUTPUT_DIR="${REPO_ROOT}/outputs/grounding_dino_elev_Karnataka_LOW_HIGH_fsall_1gpu40ep_${SLURM_JOB_ID}"
NUM_GPUS=1
...
echo "=== GroundingDINO: elev_Karnataka_train_LOW__ood_HIGH__fsall ==="
