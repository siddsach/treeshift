#!/bin/bash
#SBATCH --job-name=pd_rn_india_random_80_20
...
#SBATCH --output=logs/plaindetr_resnet_india_random_80_20_%j.out
#SBATCH --error=logs/plaindetr_resnet_india_random_80_20_%j.err

# -----------------------------------------------------------------------
# Plain-DETR + ResNet-50 FPN backbone: india_random_80_20
...
OUTPUT_DIR="${REPO_ROOT}/outputs/plaindetr_resnet_india_random_80_20_1gpu40ep_${SLURM_JOB_ID}"
...
echo "=== Plain-DETR ResNet50: india_random_80_20 ==="
