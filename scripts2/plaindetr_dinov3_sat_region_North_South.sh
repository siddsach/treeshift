#!/bin/bash
#SBATCH --job-name=pd_dv3_sat_region_North_South
...
#SBATCH --output=logs/plaindetr_dinov3_sat_region_North_South_%j.out
#SBATCH --error=logs/plaindetr_dinov3_sat_region_North_South_%j.err

# -----------------------------------------------------------------------
# Plain-DETR + DinoV3 (dino_weights_sat): region_train_North__ood_South
...
OUTPUT_DIR="${REPO_ROOT}/outputs/plaindetr_dinov3_sat_region_North_South_1gpu40ep_${SLURM_JOB_ID}"
...
echo "=== Plain-DETR DinoV3 (sat): region_train_North__ood_South ==="
