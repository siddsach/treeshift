#!/bin/bash
#SBATCH --job-name=pd_rn_region_North_South
...
#SBATCH --output=logs/plaindetr_resnet_region_North_South_%j.out
#SBATCH --error=logs/plaindetr_resnet_region_North_South_%j.err

# -----------------------------------------------------------------------
# Plain-DETR + ResNet-50 FPN backbone: region_train_North__ood_South
...
OUTPUT_DIR="${REPO_ROOT}/outputs/plaindetr_resnet_region_North_South_1gpu40ep_${SLURM_JOB_ID}"
...
echo "=== Plain-DETR ResNet50: region_train_North__ood_South ==="
