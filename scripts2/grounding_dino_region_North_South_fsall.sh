#!/bin/bash
#SBATCH --job-name=gdino_region_North_South_fsall
...
# -----------------------------------------------------------------------
# MM-Grounding-DINO: region_train_North__ood_South__fsall
# 10804 train images, batch 2/GPU × 1 GPU, 40 epochs max.
...
OUTPUT_DIR="${REPO_ROOT}/outputs/grounding_dino_region_North_South_fsall_1gpu40ep_${SLURM_JOB_ID}"
NUM_GPUS=1
...
echo "=== GroundingDINO: region_train_North__ood_South__fsall ==="
