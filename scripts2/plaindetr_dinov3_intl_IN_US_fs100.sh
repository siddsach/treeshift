#!/bin/bash
#SBATCH --job-name=pd_dv3_intl_IN_US_fs100
...
#SBATCH --output=logs/plaindetr_dinov3_intl_IN_US_fs100_%j.out
#SBATCH --error=logs/plaindetr_dinov3_intl_IN_US_fs100_%j.err

# -----------------------------------------------------------------------
# Plain-DETR + DinoV3 (ViT-S/16): intl_train_IN__ood_US__fs100
...
OUTPUT_DIR="${REPO_ROOT}/outputs/plaindetr_dinov3_intl_IN_US_fs100_1gpu40ep_${SLURM_JOB_ID}"
...
echo "=== Plain-DETR DinoV3: intl_train_IN__ood_US__fs100 ==="
