#!/bin/bash
#SBATCH --job-name=pd_dv3_7b16_region_North_South_fsall
...
#SBATCH --output=logs/plaindetr_dinov3_7b16_region_North_South_fsall_%j.out
#SBATCH --error=logs/plaindetr_dinov3_7b16_region_North_South_fsall_%j.err

# -----------------------------------------------------------------------
# Plain-DETR + DinoV3 (dino_weights_7b16): region_train_North__ood_South__fsall
# 10804 train images, batch 2/GPU × 1 A100 GPU, 40 epochs max.
...
CONFIG=region_train_North__ood_South__fsall
OUTPUT_DIR="${REPO_ROOT}/outputs/plaindetr_dinov3_7b16_region_North_South_fsall_1gpu40ep_${SLURM_JOB_ID}"
...
echo "=== Plain-DETR DinoV3 (7b16): region_train_North__ood_South__fsall ==="
