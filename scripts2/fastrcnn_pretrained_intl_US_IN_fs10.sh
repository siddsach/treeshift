#!/bin/bash
#SBATCH --job-name=frcnn_pt_intl_US_IN_fs10
...
#SBATCH --output=logs/fastrcnn_pretrained_intl_US_IN_fs10_%j.out
#SBATCH --error=logs/fastrcnn_pretrained_intl_US_IN_fs10_%j.err

# -----------------------------------------------------------------------
# Faster R-CNN (COCO pretrained): intl_train_US__ood_IN__fs10
# 8933 train images, batch 10 (1 GPU), 40 epochs = 35760 iterations.
...
OUTPUT_DIR="${REPO_ROOT}/outputs/fastrcnn_pretrained_intl_US_IN_fs10_1gpu40ep_${SLURM_JOB_ID}"
