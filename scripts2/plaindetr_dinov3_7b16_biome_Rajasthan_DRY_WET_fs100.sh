#!/bin/bash
#SBATCH --job-name=pd_dv3_7b16_biome_Rajasthan_DRY_WET_fs10
...
#SBATCH --output=logs/plaindetr_dinov3_7b16_biome_Rajasthan_DRY_WET_fs100_%j.out
#SBATCH --error=logs/plaindetr_dinov3_7b16_biome_Rajasthan_DRY_WET_fs100_%j.err

# -----------------------------------------------------------------------
# Plain-DETR + DinoV3 (dino_weights_7b16): biome_Rajasthan_train_DRY__ood_WET__fs100
# 2034 train images, batch 2/GPU × 1 A100 GPU, 40 epochs max.
...
CONFIG=biome_Rajasthan_train_DRY__ood_WET__fs100
OUTPUT_DIR="${REPO_ROOT}/outputs/plaindetr_dinov3_7b16_biome_Rajasthan_DRY_WET_fs100_1gpu40ep_${SLURM_JOB_ID}"
...
echo "=== Plain-DETR DinoV3 (7b16): biome_Rajasthan_train_DRY__ood_WET__fs100 ==="
