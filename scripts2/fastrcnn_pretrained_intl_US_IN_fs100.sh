...
# 9023 train images, batch 10 (1 GPU), 40 epochs = 36120 iterations.
...
OUTPUT_DIR="${REPO_ROOT}/outputs/fastrcnn_pretrained_intl_US_IN_fs100_1gpu40ep_${SLURM_JOB_ID}"
