#!/bin/bash
#SBATCH --job-name=pd_dv3_7b16_elev_Karnataka_HIGH_LOW_fsal
...
#SBATCH --output=logs/plaindetr_dinov3_7b16_elev_Karnataka_HIGH_LOW_fsall_%j.out
#SBATCH --error=logs/plaindetr_dinov3_7b16_elev_Karnataka_HIGH_LOW_fsall_%j.err

# -----------------------------------------------------------------------
# Plain-DETR + DinoV3 (dino_weights_7b16): elev_Karnataka_train_HIGH__ood_LOW__fsall
# 4542 train images, batch 2/GPU × 1 A100 GPU, 40 epochs max.
...
CONFIG=elev_Karnataka_train_HIGH__ood_LOW__fsall
OUTPUT_DIR="${REPO_ROOT}/outputs/plaindetr_dinov3_7b16_elev_Karnataka_HIGH_LOW_fsall_1gpu40ep_${SLURM_JOB_ID}"
...
echo "=== Plain-DETR DinoV3 (7b16): elev_Karnataka_train_HIGH__ood_LOW__fsall ==="
