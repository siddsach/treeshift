#!/bin/bash
#SBATCH --job-name=pd_dv3_sat_india_random_80_20
...
#SBATCH --output=logs/plaindetr_dinov3_sat_india_random_80_20_%j.out
#SBATCH --error=logs/plaindetr_dinov3_sat_india_random_80_20_%j.err

# -----------------------------------------------------------------------
# Plain-DETR + DinoV3 (dino_weights_sat): india_random_80_20
...
OUTPUT_DIR="${REPO_ROOT}/outputs/plaindetr_dinov3_sat_india_random_80_20_1gpu40ep_${SLURM_JOB_ID}"
...
echo "=== Plain-DETR DinoV3 (sat): india_random_80_20 ==="
