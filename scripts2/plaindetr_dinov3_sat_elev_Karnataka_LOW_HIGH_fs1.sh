#!/bin/bash
#SBATCH --job-name=pd_dv3_sat_elev_Karnataka_LOW_HIGH_fs1
...
#SBATCH --output=logs/plaindetr_dinov3_sat_elev_Karnataka_LOW_HIGH_fs1_%j.out
#SBATCH --error=logs/plaindetr_dinov3_sat_elev_Karnataka_LOW_HIGH_fs1_%j.err

# -----------------------------------------------------------------------
# Plain-DETR + DinoV3 (dino_weights_sat): elev_Karnataka_train_LOW__ood_HIGH__fs1
...
OUTPUT_DIR="${REPO_ROOT}/outputs/plaindetr_dinov3_sat_elev_Karnataka_LOW_HIGH_fs1_1gpu40ep_${SLURM_JOB_ID}"
...
echo "=== Plain-DETR DinoV3 (sat): elev_Karnataka_train_LOW__ood_HIGH__fs1 ==="
