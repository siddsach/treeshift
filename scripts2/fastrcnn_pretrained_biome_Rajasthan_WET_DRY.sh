...
# 1714 train images, batch 8 (1 GPU), 40 epochs = 8600 iterations.
...
OUTPUT_DIR="${REPO_ROOT}/outputs/fastrcnn_pretrained_biome_Rajasthan_WET_DRY_1gpu40ep_${SLURM_JOB_ID}"
