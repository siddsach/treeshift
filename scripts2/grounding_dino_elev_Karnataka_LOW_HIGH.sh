#!/bin/bash
#SBATCH --job-name=gdino_elev_Karnataka_LOW_HIGH
...
#SBATCH --output=logs/grounding_dino_elev_Karnataka_LOW_HIGH_%j.out
#SBATCH --error=logs/grounding_dino_elev_Karnataka_LOW_HIGH_%j.err

# -----------------------------------------------------------------------
# MM-Grounding-DINO: elev_Karnataka_train_LOW__ood_HIGH
# 2817 train images, batch 2/GPU × 1 GPU, 40 epochs max.
...
OUTPUT_DIR="${REPO_ROOT}/outputs/grounding_dino_elev_Karnataka_LOW_HIGH_1gpu40ep_${SLURM_JOB_ID}"
NUM_GPUS=1
...
echo "=== GroundingDINO: elev_Karnataka_train_LOW__ood_HIGH ==="
