#!/bin/bash
#SBATCH --job-name=gdino_intl_IN_US
...
#SBATCH --output=logs/grounding_dino_intl_IN_US_%j.out
#SBATCH --error=logs/grounding_dino_intl_IN_US_%j.err

# -----------------------------------------------------------------------
# MM-Grounding-DINO: intl_train_IN__ood_US
# 12143 train images, batch 2/GPU × 1 GPU, 40 epochs max.
...
OUTPUT_DIR="${REPO_ROOT}/outputs/grounding_dino_intl_IN_US_1gpu40ep_${SLURM_JOB_ID}"
NUM_GPUS=1
...
echo "=== GroundingDINO: intl_train_IN__ood_US ==="
