...
#SBATCH --output=logs/plaindetr_dinov3_7b16_biome_Rajasthan_DRY_WET_fs10_%j.out
#SBATCH --error=logs/plaindetr_dinov3_7b16_biome_Rajasthan_DRY_WET_fs10_%j.err

# -----------------------------------------------------------------------
# Plain-DETR + DinoV3 (dino_weights_7b16): biome_Rajasthan_train_DRY__ood_WET__fs10
# 1944 train images, batch 2/GPU × 1 A100 GPU, 40 epochs max.
...
CONFIG=biome_Rajasthan_train_DRY__ood_WET__fs10
OUTPUT_DIR="${REPO_ROOT}/outputs/plaindetr_dinov3_7b16_biome_Rajasthan_DRY_WET_fs10_1gpu40ep_${SLURM_JOB_ID}"
...
echo "=== Plain-DETR DinoV3 (7b16): biome_Rajasthan_train_DRY__ood_WET__fs10 ==="
