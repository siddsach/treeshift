...
#SBATCH --output=logs/plaindetr_dinov3_7b16_elev_Karnataka_HIGH_LOW_fs100_%j.out
#SBATCH --error=logs/plaindetr_dinov3_7b16_elev_Karnataka_HIGH_LOW_fs100_%j.err

# -----------------------------------------------------------------------
# Plain-DETR + DinoV3 (dino_weights_7b16): elev_Karnataka_train_HIGH__ood_LOW__fs100
# 2451 train images, batch 2/GPU × 1 A100 GPU, 40 epochs max.
...
OUTPUT_DIR="${REPO_ROOT}/outputs/plaindetr_dinov3_7b16_elev_Karnataka_HIGH_LOW_fs100_1gpu40ep_${SLURM_JOB_ID}"
...
echo "=== Plain-DETR DinoV3 (7b16): elev_Karnataka_train_HIGH__ood_LOW__fs100 ==="
