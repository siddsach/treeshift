#!/bin/bash
#SBATCH --job-name=frcnn_pt_elev_Karnataka_HIGH_LOW_fs10
...
#SBATCH --output=logs/fastrcnn_pretrained_elev_Karnataka_HIGH_LOW_fs10_%j.out
#SBATCH --error=logs/fastrcnn_pretrained_elev_Karnataka_HIGH_LOW_fs10_%j.err

# -----------------------------------------------------------------------
# Faster R-CNN (COCO pretrained): elev_Karnataka_train_HIGH__ood_LOW__fs10
# 2361 train images, batch 8 (1 GPU), 40 epochs = 11840 iterations.
...
OUTPUT_DIR="${REPO_ROOT}/outputs/fastrcnn_pretrained_elev_Karnataka_HIGH_LOW_fs10_1gpu40ep_${SLURM_JOB_ID}"
