#!/bin/bash
#SBATCH --job-name=mrcnn_pt_intl_US_IN
...
#SBATCH --output=logs/maskrcnn_pretrained_intl_US_IN_%j.out
#SBATCH --error=logs/maskrcnn_pretrained_intl_US_IN_%j.err

# -----------------------------------------------------------------------
# Mask R-CNN (COCO pretrained): intl_train_US__ood_IN
...
OUTPUT_DIR="${REPO_ROOT}/outputs/maskrcnn_pretrained_intl_US_IN_1gpu40ep_${SLURM_JOB_ID}"
