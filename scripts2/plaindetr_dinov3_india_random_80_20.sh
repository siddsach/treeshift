#!/bin/bash
#SBATCH --job-name=pd_dv3_india_random_80_20
...
#SBATCH --output=logs/plaindetr_dinov3_india_random_80_20_%j.out
#SBATCH --error=logs/plaindetr_dinov3_india_random_80_20_%j.err

# -----------------------------------------------------------------------
# Plain-DETR + DinoV3 (ViT-S/16): india_random_80_20
...
OUTPUT_DIR="${REPO_ROOT}/outputs/plaindetr_dinov3_india_random_80_20_1gpu40ep_${SLURM_JOB_ID}"
...
echo "=== Plain-DETR DinoV3: india_random_80_20 ==="
